                ...
                'pages' => [
                    [
                        ...
                        'fields' => [
                            ...
                            self::field('friendlycaptcha', 'friendlycaptcha', 'Spam protection', 'Spam-Schutz'),
                            self::field('submit', 'submit', 'Request a callback', 'Rueckruf anfordern'),
                        ],
                    ],
                ],
            ],
                ...
                'pages' => [
                    [
                        ...
                        'fields' => [
                            ...
                            self::field('input', 'phone', 'Phone', 'Telefon', ['mandatory' => true, 'placeholderEn' => '+43 ...', 'placeholderDe' => '+43 ...']),
                            self::field('input', 'company', 'Company', 'Unternehmen', ['mandatory' => true]),
                            self::field('select', 'role', 'Your role', 'Ihre Rolle', ['mandatory' => true, 'options' => [['Management', 'Geschaeftsfuehrung', 'management'], ['Marketing', 'Marketing', 'marketing'], ['IT and development', 'IT / Entwicklung', 'it'], ['Other', 'Sonstiges', 'other']]]),
                        ],
                    ],
                    [
                        'titleEn' => 'Project',
                        ...
                        'fields' => [
                            ...
                            self::field('check', 'features', 'Required features', 'Benoetigte Funktionen', ['mandatory' => true, 'options' => [['Several languages', 'Mehrsprachigkeit', 'multilanguage'], ['Forms', 'Formulare', 'forms'], ['Search', 'Suche', 'search'], ['News or blog', 'News / Blog', 'news'], ['Shop integration', 'Shop-Anbindung', 'shop']]]),
                        ],
                    ],
                    [
                        ...
                        'fields' => [
                            self::field('radio', 'budget', 'Budget range', 'Budgetrahmen', ['mandatory' => true, 'options' => [['Under €10,000', 'Unter 10.000 Euro', 'small'], ['€10,000 to €25,000', '10.000 bis 25.000 Euro', 'medium'], ['€25,000 to €50,000', '25.000 bis 50.000 Euro', 'large'], ['Over €50,000', 'Ueber 50.000 Euro', 'enterprise']]]),
                            self::field('select', 'start', 'Preferred start', 'Gewuenschter Start', ['mandatory' => true, 'options' => [['As soon as possible', 'So bald wie moeglich', 'asap'], ['This quarter', 'Dieses Quartal', 'quarter'], ['This year', 'Dieses Jahr', 'year'], ['Flexible', 'Flexibel', 'flexible']]]),
                    ...
                    [
                        ...
                        'fields' => [
                            ...
                            self::field('check', 'newsletter', 'Newsletter', 'Newsletter', ['options' => [['Send me news about TYPO3 and Desiderio.', 'Halten Sie mich ueber TYPO3- und Desiderio-News auf dem Laufenden.', 'yes']]]),
                            self::field('check', 'privacy', 'Privacy', 'Datenschutz', ['mandatory' => true, 'options' => [['I agree that this request may be processed.', 'Ich stimme der Verarbeitung dieser Anfrage zu.', 'accepted']]]),
                            self::field('hidden', 'source', 'Source', 'Quelle', ['prefill' => 'desiderio-powermail-demo']),
                            self::field('friendlycaptcha', 'friendlycaptcha', 'Spam protection', 'Spam-Schutz'),
