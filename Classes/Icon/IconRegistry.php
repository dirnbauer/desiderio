    ...
    public static function icons(): array
    {
        return [
            ...
            'brand-google-play' => [
                'label' => 'Google Play',
                'group' => 'Social',
                'paths' => '<path d="M4 3.71v16.58a.7.7 0 0 0 1.05.606l14.622-8.42a.55.55 0 0 0 0-.953L5.05 3.104A.7.7 0 0 0 4 3.71z"/><path d="M15 9 4.5 20.5"/><path d="m4.5 3.5 10.5 11.5"/>',
            ],
            'brand-youtube' => [
                'label' => 'YouTube',
                'group' => 'Social',
            ...
            'tablet' => [
                'label' => 'Tablet',
                'group' => 'Navigation',
                'paths' => '<rect width="16" height="20" x="4" y="2" rx="2"/><path d="M12 18h.01"/>',
            ],
            'smartphone' => [
                'label' => 'Smartphone',
                'group' => 'Navigation',
                'paths' => '<rect width="14" height="20" x="5" y="2" rx="2"/><path d="M12 18h.01"/>',
            ],
            'globe' => [
                'label' => 'Globe',
                'group' => 'Places',
